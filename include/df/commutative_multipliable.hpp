...
#ifndef DF_INCLUDE_COMMUTATIVE_MULTIPLIABLE_HPP
#define DF_INCLUDE_COMMUTATIVE_MULTIPLIABLE_HPP
...
namespace df
{
  namespace operators_impl // ADL protector
  {
    ...
    class commutative_multipliable
    {
    ...
    template< typename T >
    class commutative_multipliable< T >
    {
